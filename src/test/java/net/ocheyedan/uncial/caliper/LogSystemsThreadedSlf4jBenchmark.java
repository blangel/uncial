 ...
 * This is different than {@link LogSystemsBenchmark} in that it configures {@literal Uncial} to use the {@literal slf4j}
 * style formatting.
 */
public class LogSystemsThreadedSlf4jBenchmark extends SimpleBenchmark {
    ...
    public static void main(String[] args) throws Exception {
        Runner.main(LogSystemsThreadedSlf4jBenchmark.class, args);
    }
}
