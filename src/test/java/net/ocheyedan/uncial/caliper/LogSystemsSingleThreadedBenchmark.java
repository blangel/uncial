 ...
 * and use its default {@literal printf} style formatting.
 */
public class LogSystemsSingleThreadedBenchmark extends SimpleBenchmark {
    ...
    public static void main(String[] args) throws Exception {
        Runner.main(LogSystemsSingleThreadedBenchmark.class, args);
    }
}
